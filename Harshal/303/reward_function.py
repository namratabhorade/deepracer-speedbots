...
def reward_function(params):
    ...
    print("--------------------")
    reward = (2 * near_center_per/100) + (7 * (100-direction_diff_angle)/100)
    ...
    reward = (((near_center_per/10 + 5 * progress/10) ** 2) * (100-direction_diff_angle)/100) / steps
